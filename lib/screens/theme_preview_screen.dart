        ...
        child: SafeArea(
          child: ListView(
            ...
            children: [
              ...
              Center(child: ThemeMock(theme: theme, width: 170, height: 170, compact: true)),
              const SizedBox(height: 28),
              _label('MEDIUM', onBg),
              const SizedBox(height: 10),
              ThemeMock(theme: theme, width: double.infinity, height: 170),
              const SizedBox(height: 28),
              _label('LARGE', onBg),
              const SizedBox(height: 10),
              ThemeMock(theme: theme, width: double.infinity, height: 320),
            ],
          ),
        ),
      ),
